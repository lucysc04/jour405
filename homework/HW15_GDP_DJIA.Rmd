...
There is a very strong positive relationship between the GDP and the DJIA with a correlation coefficient of 0.95. This shows that as GDP increases, so does DJIA. The scatterplot supports this relationship, showing a clear upward trend with points closely clustered around the regression line. There is little scatter which means there is a strong linear relationship.
