...
When the sample size is 100, the mean and SD are usually close to the population values because the larger sample better represents the overall population. When it is reduced, the mean tends to vary more from the population mean and the SD  is less consistent. Smaller samples = more variability, larger samples = reliable estimates.
