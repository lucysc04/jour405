...
yes it is overall a useful model but mainly because of th points scored variable. It is the only clealry significant predictor=carrying a lot of the explanation.  Takeaways is marginally significant and yards gained is not significant ar al and has an negative relationship- doesn't add value. the model could be improved by removing the weaker variables and focusing on strong ones like points scored.
...
Points scored has the strongest impact on wins , followed by takeaways then yards gained. 
...
You could use this to explain why a team is winning or losing. For example you could show that a team’s success is driven more by scoring and forcing turnovers than just gaining yards. It helps the journalist turn game stats into a story about what actually leads to wins.
