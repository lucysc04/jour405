...
Most days have a cluster with a consistent range. There are some spikes where the number of calls is noticeably higher- most values fall within a middle range.To highlight unusual days, horizontal lines could be placed just outside the typical range. This would help me to visually spot outliers quickly before confirming them with z-scores.
...
The unusual days stand out more clearly than in the visual estimates from Task 3. The z-score calculation identifies which days are unusual (beyond +2 sds). Some of the spikes I can see visually are confirmed as unusually high call days, while others that looked high may still fall within the normal range. Using z-scores provides a more accurate way to identify unusual days.
...
I would call this day the most abnormally high/low day of the year for calls.
...
I would tell my editor that the data shows clear spikes in overdose-related 911 calls that stand out. These stats could lead to further reporting on what caused them and how the county responds to the surges.
