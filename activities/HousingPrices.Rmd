...
A new light rail extension may be raising home values in a local neighborhood, with recent sales averaging about nearly $20,000 higher than before the line opened. New data has provided statistical evidence to support the claim that the transit line has increased prices. Still, although statistically significant, housing markets are influenced by a variety of factors and we cannot rely on data alone to prove the rail line is the main cause. 
